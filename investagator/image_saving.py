...
def image_to_objects(img_path):
    # This is a neural network that makes use of imagenet and has 99% accuracy
...
files = glob("/Users/erics/Documents/ai_conf/investagator/app/static/images/*")
for file_name in files:
    labels = image_to_objects(file_name)
    for label in labels:
        data = {}
        data["label"] = label
